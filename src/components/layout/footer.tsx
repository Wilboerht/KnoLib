      ...
      <Container>
        <div className="py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="flex items-center space-x-2 mb-4">
                <div className="h-8 w-8 flex items-center justify-center">
                  <KnoLibIcon className="h-8 w-8 text-slate-900 dark:text-white" />
                </div>
                <span className="font-bold text-xl text-foreground">KnoLib</span>
              </div>
              <p className="text-sm text-muted-foreground mb-4">
                Your comprehensive knowledge library for continuous learning and professional growth. Discover, learn, and excel with KnoLib.
              </p>
            ...
            <div>
              <h3 className="text-sm font-semibold text-foreground mb-4">Link</h3>
              <ul className="space-y-3">
                {footerNavigation.link.map((item) => (
                  <li key={item.name}>
                    <Link
                      href={item.href}
                      className="text-sm text-muted-foreground hover:text-foreground transition-colors"
          ...
          <div className="mt-12 pt-8 border-t border-slate-200 dark:border-slate-700">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-sm text-muted-foreground">
                Copyright © 2025 Knolib. All Rights Reserved.
              </p>
