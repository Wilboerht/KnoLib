...
export const GitHubLogo: React.FC<LogoProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const MicrosoftLogo: React.FC<LogoProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const WeChatLogo: React.FC<LogoProps> = ({ className = '', size = 24 }) => (
  <img
    src="/wechat-logo.png"
    alt="微信"
    width={size}
...
export const AlipayLogo: React.FC<LogoProps> = ({ className = '', size = 24 }) => (
  <img
    src="/alipay-logo.png"
    alt="支付宝"
    width={size}
...
// 统一的 OAuth Logo 组件
export const OAuthLogo: React.FC<{
  provider: string;
  className?: string;
  size?: number;
}> = ({ provider, className = '', size = 24 }) => {
  switch (provider.toLowerCase()) {
    ...
    case 'wechat':
      return <WeChatLogo className={className} size={size} />;
    case 'alipay':
